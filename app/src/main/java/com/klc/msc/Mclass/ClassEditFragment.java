...
public class ClassEditFragment extends Fragment implements View.OnClickListener
{
    ...
    private Bundle       classDataBundle;
    private List<MClass> classItem;
    ...
    {
        classDataBundle = this.getArguments();
        if (classDataBundle != null) {
            classItem.add((MClass) classDataBundle.getParcelable("classData"));
        }
        Log.d(TAG, "initView: " + classItem.get(0).getHours());
        ...
        //Set class data to the components
        etClassName.setText(classItem.get(0).getName());
        etClassPrice.setText(String.valueOf(classItem.get(0).getPrice()));
        etClassDescription.setText(classItem.get(0).getDescription());
        etClassLocation.setText(classItem.get(0).getLocation());
        etClassHour.setText(String.valueOf(classItem.get(0).getHours()));
        etClassLessonNumber.setText(String.valueOf(classItem.get(0).getLessonNo()));
        etClassStudentNumber.setText(String.valueOf(classItem.get(0).getMaxStudentNo()));
        btnClassStartDate.setText(classItem.get(0).getStartDate());
        btnClassEndDate.setText(classItem.get(0).getEndDate());
        btnClassStartTime.setText(classItem.get(0).getStartTime());
        btnClassEndTime.setText(classItem.get(0).getEndTime());
    ...
    private void updateClass()
    {
        ...
        db.update(
                MSC_Contract.MSCEntry.TABLE_CLASS, values,
                MSC_Contract.MSCEntry.COL_CLASS_ID + " = ?",
                new String[]{String.valueOf(classItem.get(0).getId())}
        );
        clearForm();
        finishInsert();
        db.close();
    ...
    private void finishInsert()
    {
        ...
        dialog.setMessage("Class has been updated !");
